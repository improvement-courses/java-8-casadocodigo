...
//		Usuario nuull = null;
		...
		users.stream().peek(Usuario::tornarModerador).forEach(u -> System.out.println(u.isModerador()));

		users.sort(Comparator.comparingInt(Usuario::getPontos).thenComparing(Usuario::getNome));

		System.out.println();
		users.forEach(System.out::println);

		users.sort(Comparator.nullsLast(Comparator.comparingInt(Usuario::getPontos).thenComparing(Usuario::getNome))
				.reversed());
